		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					mov r3.xyz, v2.xyzx
					mov r3.w, l(1.000000)
					mul r4.xyzw, r3.xyzw, cb0[3].xyzw
					mul r2.xyz, r4.wwww, r4.xyzx
					mov o1.xyz, r2.xyzx
					mov r5.xyz, -r2.xyzx
					mov r5.w, -r4.w
					mul r6.xyz, cb0[5].wwww, cb0[5].xyzx
					mov r6.w, cb0[5].w
					...
					mad r0.w, r0.w, r0.z, l(1.000000)
					div r1.x, r0.z, r0.w
					mul r0.w, cb0[6].x, cb0[22].w
					mul r0.w, r0.w, l(0.500000)
					mul r1.y, r1.x, r0.w
					add r1.y, r1.y, r1.y
					min r1.y, r1.y, l(1.000000)
					sqrt r1.y, r1.y
					mul r2.xyzw, r5.xyzw, r1.yyyy
					mad o2.xyz, r4.xyzx, r4.wwww, r2.xyzx
					mad o2.w, r3.w, cb0[3].w, r2.w
					max r2.xyzw, cb0[26].xyzw, l(-20000000000.000000, -20000000000.000000, -20000000000.000000, -20000000000.000000)
					min r2.xyzw, r2.xyzw, l(20000000000.000000, 20000000000.000000, 20000000000.000000, 20000000000.000000)
					add r1.yz, r0.xxyx, -r2.xxyx
					mad r0.xy, r0.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), -r2.xyxx
					...
					mad r0.x, -r0.x, l(0.500000), l(0.500000)
					mad r1.w, r0.x, r1.x, l(-0.500000)
					mad o4.y, -r0.w, r1.x, r1.w
					mad o4.z, r0.w, r1.x, r1.w
					mov o4.xw, r1.xxxw
					mov o6.z, v2.w
					mov o6.w, l(0)
					mul r1.xyzw, cb0[19].wzxy, cb0[23].yyyy
					mul r0.yw, -r1.zzzw, cb0[28].xxxx
					div r0.yw, r0.yyyw, cb0[27].zzzw
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					dcl_output o0.xyzw
					dcl_temps 2
					add r0.xyzw, v1.xyzw, -v2.xyzw
					sample r1.xyzw, v3.xyxx, t0.xyzw, s0
					mad_sat r1.xy, r1.wwww, v4.xxxx, -v4.zyzz
					mad r0.xyzw, r1.xxxx, r0.xyzw, v2.xyzw
					mul o0.xyzw, r1.yyyy, r0.xyzw
					ret 
					// Approximately 0 instruction slots used"
				}
				SubProgram "d3d11 " {
					...
					mad_sat r0.x, r0.w, v7.x, -v7.y
					mul r1.xyz, cb0[18].wwww, cb0[18].xyzx
					mov r1.w, cb0[18].w
					mul r0.xyzw, r0.xxxx, r1.xyzw
					add r1.xyzw, v1.xyzw, -v2.xyzw
					sample r2.xyzw, v3.xyxx, t0.xyzw, s0
					mad_sat r2.xy, r2.wwww, v4.xxxx, -v4.zyzz
					mad r1.xyzw, r2.xxxx, r1.xyzw, v2.xyzw
					mul r3.xyzw, r2.yyyy, r1.xyzw
					mad r1.x, -r1.w, r2.y, l(1.000000)
					mad r0.xyzw, r0.xyzw, r1.xxxx, r3.xyzw
					mul o0.xyzw, r0.xyzw, v6.zzzz
					ret 
					// Approximately 0 instruction slots used"
				}
				SubProgram "d3d11 " {
				...
				SubProgram "d3d11 " {
					...
					mad r1.x, -r1.w, r2.y, l(1.000000)
					mad r0.xyzw, r0.xyzw, r1.xxxx, r3.xyzw
					mad r1.x, r0.w, v6.z, l(-0.001000)
					mul r0.xyzw, r0.xyzw, v6.zzzz
					mov o0.xyzw, r0.xyzw
					lt r0.x, r1.x, l(0.000000)
					discard_nz r0.x
					ret 
				...
				SubProgram "d3d11 " {
					...
					dcl_output o0.xyzw
					dcl_temps 2
					add r0.xy, -cb0[26].xyxx, cb0[26].zwzz
					add r0.xy, r0.xyxx, -|v5.xyxx|
					mul_sat r0.xy, r0.xyxx, v5.zwzz
					mul r0.x, r0.y, r0.x
					sample r1.xyzw, v3.xyxx, t0.xyzw, s0
					mad_sat r0.y, r1.w, v4.x, -v4.w
					mul r1.xyzw, r0.yyyy, v1.xyzw
