		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					add r0.x, r0.x, -v2.z
					mad r0.x, r0.x, v2.w, l(0.500000)
					mul r0.y, cb0[8].x, cb0[24].w
					mul r0.z, cb0[6].y, cb0[24].w
					mul r0.yw, r0.yyyz, v2.wwww
					mul r1.xyzw, v6.xyzw, cb0[5].xyzw
					mul r2.x, v6.w, cb0[7].w
					mad r2.yz, cb0[4].xxyx, cb1[0].yyyy, v1.zzwz
					sample r3.xyzw, r2.yzyy, t1.xyzw, s1
					mul r1.xyzw, r1.xyzw, r3.xyzw
					mad r2.yz, cb0[6].zzwz, cb1[0].yyyy, v2.xxyx
					sample r3.xyzw, r2.yzyy, t2.xyzw, s2
					mul r2.yzw, r3.xxyz, cb0[7].xxyz
					mul r3.w, r2.x, r3.w
					mad r2.x, -r0.y, l(0.500000), r0.x
					mad r0.w, r0.w, l(0.500000), r2.x
					mad r0.z, r0.z, v2.w, l(1.000000)
					...
					if_nz r1.x
					  ...
					  add r1.yzw, r1.yyzw, -cb3[6].xxyz
					  mul r2.yzw, r1.yyzw, cb3[5].xxyz
					  mad r1.y, r2.y, l(0.250000), l(0.750000)
					  mad r1.z, cb3[0].z, l(0.500000), l(0.750000)
					  max r2.x, r1.z, r1.y
					...
					if_nz r1.x
					  ...
					  mov r4.z, v4.w
					  mov r4.w, v5.w
					  movc r3.xyz, r1.xxxx, r3.xyzx, r4.yzwy
					  add r3.xyz, r3.xyzx, -cb3[6].xyzx
					  mul r3.yzw, r3.xxyz, cb3[5].xxyz
					  mul r1.x, r3.y, l(0.250000)
					  mul r3.y, cb3[0].z, l(0.500000)
					  mad r4.x, -cb3[0].z, l(0.500000), l(0.250000)
					  max r1.x, r1.x, r3.y
					  min r3.x, r4.x, r1.x
					  ...
					  mov r2.w, l(1.000000)
					  dp4 r4.x, cb2[39].xyzw, r2.xyzw
					  dp4 r4.y, cb2[40].xyzw, r2.xyzw
					  dp4 r4.z, cb2[41].xyzw, r2.xyzw
					endif 
